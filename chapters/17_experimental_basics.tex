...
\textbf{Resonator spectroscopy.} The readout resonator is side-coupled
to the feedline, so its transmission traces the notch dip
\cref{eq:notch-s21} centred at the dressed cavity frequency, whose
location depends on the qubit state through the dispersive pull
$\pm\chi$ (\cref{stmt:dispersive-H}):
\begin{equation}
