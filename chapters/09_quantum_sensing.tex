...
\paragraph{Evidence for dark matter.}
...
\paragraph{The microwave window.}
...
% --------------------------------------------------------------
The combination of macroscopic quantum coherence at GHz, single
microwave-photon sensitivity, and millikelvin operating
temperature places superconducting circuits in an unusually
favourable position to detect feeble signals from beyond the
Standard Model. The four sensing mechanisms surveyed above ---
phonon-quasiparticle conversion, infrared absorption in the
junction, piezoelectric phonon-qubit coupling, and direct
microwave absorption in the qubit --- between them cover the
sub-GeV recoil and ultralight-boson windows that traditional
cryogenic detectors and dual-phase TPCs do not reach. Each is at
a different stage of experimental maturity; the limiting
backgrounds (quasiparticle poisoning, two-level-system loss in
the substrate, stray IR through the cryostat) are the same ones
that limit cQED quantum-information hardware, and progress on one
front feeds the other.

\clearpage
\begin{chaptersummary}

\paragraph{cQED as a fundamental-physics front end.}
