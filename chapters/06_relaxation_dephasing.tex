...
the coherence budget, made precise in \cref{sec:bloch} below.
...
Part~III) refocus the slow noise and recover $T_2$ from $T_2^*$.
\end{remark}
...
\begin{statement}[\textbf{Rates from the noise spectrum}]
