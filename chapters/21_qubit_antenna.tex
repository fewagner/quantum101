...
\cite{pozar2011,balanis2016}. Solving \cref{eq:helmholtz-A} for the
...
3$--$8\,\text{GHz}$, and whose radiative coupling to its
electromagnetic environment is itself an engineerable, antenna-like
channel~\cite{houck2008}.  At much higher frequencies the same
