...
\begin{note}
This \emph{charge} parity --- the even/odd count of unpaired electrons
on the island --- is a different observable from the \emph{photon-number}
parity that serves as the cat-code error syndrome in
\cref{stmt:bosonic-codes}: both are read out dispersively through a
qubit, but one counts quasiparticles and the other counts photons.
\end{note}
